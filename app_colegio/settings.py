...
SECRET_KEY = 'django-insecure-=o=!q@3a2wi%a54@$p36a@w-2rhwv1k-_jlci#7h)8$#xo+&+3'
...
AUTH_USER_MODEL = 'colegio.Docente'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=2, minutes=30)
}